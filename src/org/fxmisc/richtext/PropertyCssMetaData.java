...
public class PropertyCssMetaData<S extends Styleable, V> extends
  CssMetaData<S, V> {

  private final StyleableObjectProperty<V> property;

  public PropertyCssMetaData(StyleableObjectProperty<V> property,
    String cssProperty, StyleConverter<?, V> converter, V initialValue) {
