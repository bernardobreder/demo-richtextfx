...
class CssProperties {
  ...
  static final PseudoClass PSEUDO_CLASS_READONLY = PseudoClass.getPseudoClass(
    "readonly");

  static class EditableProperty<R extends Region> extends
    ...
    protected void invalidated() {
      ((Region) getBean()).pseudoClassStateChanged(PSEUDO_CLASS_READONLY,
        !get());
    }
  }

  static class FontProperty<S extends Styleable> extends
    StyleableObjectProperty<Font> {
    ...
    public FontProperty(S textArea) {
      ...
      this.cssMetaData = new PropertyCssMetaData<S, Font>(this, "-fx-font",
  ...
  static class HighlightFillProperty extends StyleableObjectProperty<Paint> {
    ...
    public HighlightFillProperty(Object bean, Paint initialValue) {
      super(initialValue);
      this.bean = bean;
      cssMetaData = new PropertyCssMetaData<>(this, "-fx-highlight-fill",
  ...
  static class HighlightTextFillProperty extends
    ...
    public HighlightTextFillProperty(Object bean, Paint initialValue) {
      super(initialValue);
      this.bean = bean;
      cssMetaData = new PropertyCssMetaData<>(this, "-fx-highlight-text-fill",
        StyleConverter.getPaintConverter(), initialValue);
    }
