...
/**
 * AreaFactory is a convenience class used to create StyledTextArea and any of
 * its subclasses. and optionally embed them into a
...
public class AreaFactory {
  ...
  public static <PS, S> StyledTextArea<PS, S> styledTextArea(
    ...
    return new StyledTextArea<>(initialParagraphStyle, applyParagraphStyle,
  ...
  public static <PS, S> VirtualizedScrollPane<StyledTextArea<PS, S>> embeddedStyledTextArea(
    PS initialParagraphStyle, BiConsumer<TextFlow, PS> applyParagraphStyle,
    S initialTextStyle, BiConsumer<? super TextExt, S> applyStyle) {
    return new VirtualizedScrollPane<>(styledTextArea(initialParagraphStyle,
  ...
  public static <PS, S> VirtualizedScrollPane<StyledTextArea<PS, S>> embeddedStyledTextArea(
    ...
    boolean preserveStyle) {
    return new VirtualizedScrollPane<>(styledTextArea(initialParagraphStyle,
      applyParagraphStyle, initialTextStyle, applyStyle, preserveStyle));
  }

  // Clones StyledTextArea
  public static <PS, S> StyledTextArea<PS, S> cloneStyleTextArea(
    StyledTextArea<PS, S> area) {
    return new StyledTextArea<>(area.getInitialParagraphStyle(), area
      .getApplyParagraphStyle(), area.getInitialTextStyle(), area
        .getApplyStyle(), area.getModel().getContent(), area.isPreserveStyle());
  }
  ...
  public static <PS, S> VirtualizedScrollPane<StyledTextArea<PS, S>> embeddedClonedStyledTextArea(
    ...
    return embeddedClonedStyledTextArea(virtualizedScrollPaneWithArea
      .getContent());
  }
  ...
  public static StyleClassedTextArea cloneStyleClassedTextArea(
    StyleClassedTextArea area) {
    return new StyleClassedTextArea(area.getModel().getContent(), area
      .isPreserveStyle());
  }
  ...
  public static VirtualizedScrollPane<StyleClassedTextArea> embeddedClonedStyleClassedTextArea(
    ...
    return embeddedClonedStyleClassedTextArea(virtualizedScrollPaneWithArea
      .getContent());
  }
  ...
  public static VirtualizedScrollPane<CodeArea> embeddedClonedCodeArea(
    ...
    return new VirtualizedScrollPane<>(cloneCodeArea(
      virtualizedScrollPaneWithArea.getContent()));
  }
  ...
  public static InlineCssTextArea cloneInlineCssTextArea(
  ...
  public static VirtualizedScrollPane<InlineCssTextArea> embeddedClonedInlineCssTextArea(
    ...
    return new VirtualizedScrollPane<>(cloneInlineCssTextArea(
      virtualizedScrollPaneWithArea.getContent()));
  }
}
