...
public interface TwoDimensional {
  ...
  interface Position {
    ...
    /**
     * Returns {@code true} if the given position is equal to this position,
     * that is they both point to the same place in the same two-dimensional
     * object. Otherwise returns {@code false}.
     */
