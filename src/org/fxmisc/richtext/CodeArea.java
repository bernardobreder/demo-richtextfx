...
/**
 * A convenience subclass of {@link StyleClassedTextArea} with fixed-width font
 * and an undo manager that observes only plain text changes (not styled
 * changes).
 */
public class CodeArea extends StyleClassedTextArea {

  {
    ...
    getStylesheets().add(CodeArea.class.getResource("code-area.css")
      .toExternalForm());
