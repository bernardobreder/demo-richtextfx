...
public abstract class MouseStationaryEvent extends InputEvent {
  ...
  public static final EventType<MouseStationaryEvent> ANY = new EventType<>(
    InputEvent.ANY, "MOUSE_STATIONARY_ANY");
  ...
  private MouseStationaryEvent(Object source, EventTarget target,
