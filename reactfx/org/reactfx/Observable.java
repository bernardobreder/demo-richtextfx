 ...
 * have aliases that are more descriptive for the specific type, for example, in
 * {@link EventStream}, {@linkplain #observe(Object)} is aliased as
 ...
 * canonical observer. For example, the canonical observer for {@code Val<T>} is
 * an <em>invalidation observer</em>, which is of type
 * {@code Consumer<? super T>}, which accepts the invalidated value. In addition
 * to this canonical observer, {@linkplain Val} also supports
