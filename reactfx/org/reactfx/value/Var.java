...
public interface Var<T> extends Val<T>, Property<T> {
   ...
   * method.
   *
   * @param obs {@linkplain ObservableValue} whose value can be changed by the
   *        {@code setValue} function.
   * @param setValue function used to set the value of {@code obs}. When invoked
   *        with a value {@code x}, it should perform an action that may or may
   *        not result in a change of {@code obs}'s value to {@code x}.
   */
   ...
   * with the consequences of {@linkplain DoubleProperty} not being a subtype of
   * {@code Property<Double>}.
   */
  ...
  /**
   * Converts {@linkplain FloatProperty} to {@code Var<Float>} to help deal with
   * the consequences of {@linkplain FloatProperty} not being a subtype of
   * {@code Property<Float>}.
   */
  ...
  /**
   * Converts {@linkplain IntegerProperty} to {@code Var<Integer>} to help deal
   * with the consequences of {@linkplain IntegerProperty} not being a subtype
   * of {@code Property<Integer>}.
   */
  ...
  /**
   * Converts {@linkplain LongProperty} to {@code Var<Long>} to help deal with
   * the consequences of {@linkplain LongProperty} not being a subtype of
   * {@code Property<Long>}.
   */
  ...
  static <T, U> Var<U> mapBidirectional(Property<T> src,
    Function<? super T, ? extends U> f, Function<? super U, ? extends T> g) {
  ...
  static <T> SuspendableVar<T> suspendable(Property<T> p) {
    if (p instanceof SuspendableVar) {
      ...
      Var<T> var = p instanceof Var ? (Var<T>) p : new VarWrapper<>(p);
  ...
  default <U> Var<U> mapBidirectional(Function<? super T, ? extends U> f,
