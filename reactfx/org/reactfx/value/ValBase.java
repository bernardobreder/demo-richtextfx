...
public abstract class ValBase<T> extends ObservableBase<Consumer<? super T>, T>
   ...
   * observers of this {@linkplain Val}. By the time of calling
   * {@linkplain #invalidate()}, the input observer must have already updated
   * any internal state of this {@linkplain Val}, so that a subsequent call to
   * {@link #computeValue()} returns the current value of this {@linkplain Val}.
   *
