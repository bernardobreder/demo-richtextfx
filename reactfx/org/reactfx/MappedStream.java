...
class MappedStream<T, U> extends EventStreamBase<U> {
  ...
  public MappedStream(EventStream<T> input,
...
class MappedToCompletionStageStream<T, U> extends
  MappedStream<T, CompletionStage<U>> implements CompletionStageStream<U> {
...
class MappedToTaskStream<T, U> extends MappedStream<T, Task<U>> implements
  TaskStream<U> {

  public MappedToTaskStream(EventStream<T> input,
