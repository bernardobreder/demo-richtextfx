...
public class Tuple6<A, B, C, D, E, F> {
  ...
  public <T> T map(
    HexaFunction<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? extends T> f) {
    return f.apply(_1, _2, _3, _4, _5, _6);
  }

  public boolean test(
    HexaPredicate<? super A, ? super B, ? super C, ? super D, ? super E, ? super F> f) {
    return f.test(_1, _2, _3, _4, _5, _6);
  }

  public void exec(
    HexaConsumer<? super A, ? super B, ? super C, ? super D, ? super E, ? super F> f) {
  ...
  public boolean equals(Object other) {
    if (other instanceof Tuple6) {
      ...
      return Objects.equals(this._1, that._1) && Objects.equals(this._2,
        that._2) && Objects.equals(this._3, that._3) && Objects.equals(this._4,
          that._4) && Objects.equals(this._5, that._5) && Objects.equals(
            this._6, that._6);
    }
    else {
      return false;
  ...
  public String toString() {
    return "(" + Objects.toString(_1) + ", " + Objects.toString(_2) + ", "
      + Objects.toString(_3) + ", " + Objects.toString(_4) + ", " + Objects
        .toString(_5) + ", " + Objects.toString(_6) + ")";
  }
}
