...
public abstract class LL<T> implements Iterable<T> {
  ...
  private static class Nil<T> extends LL<T> {
    ...
    @Override
    public <R> Optional<R> mapReduce(Function<? super T, ? extends R> map,
  ...
  public static final class Cons<T> extends LL<T> {
    ...
    public <R> R mapReduce1(Function<? super T, ? extends R> map,
      BinaryOperator<R> reduce) {
  ...
  public abstract <R> Optional<R> mapReduce(
    Function<? super T, ? extends R> map, BinaryOperator<R> reduce);
  ...
  public <U> U mapFirst3(
    TriFunction<? super T, ? super T, ? super T, ? extends U> f) {
    return tail().mapFirst2(f.pApply(head()));
  }

  public <U> U mapFirst4(
    TetraFunction<? super T, ? super T, ? super T, ? super T, ? extends U> f) {
    return tail().mapFirst3(f.pApply(head()));
  }

  public <U> U mapFirst5(
    PentaFunction<? super T, ? super T, ? super T, ? super T, ? super T, ? extends U> f) {
    return tail().mapFirst4(f.pApply(head()));
  }

  public <U> U mapFirst6(
    HexaFunction<? super T, ? super T, ? super T, ? super T, ? super T, ? super T, ? extends U> f) {
