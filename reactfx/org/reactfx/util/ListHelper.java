...
public abstract class ListHelper<T> {
  ...
  public static <T> T get(ListHelper<T> listHelper, int index) {
    Lists.checkIndex(index, size(listHelper)); // always throws for listHelper
                                               // == null
  ...
  public static <T> void forEachBetween(ListHelper<T> listHelper, int from,
    int to, Consumer<? super T> f) {
  ...
  public static <T> Iterator<T> iterator(ListHelper<T> listHelper, int from,
    int to) {
    Lists.checkRange(from, to, size(listHelper));
    if (from < to) {
  ...
  public static <T> Optional<T> reduce(ListHelper<T> listHelper,
    BinaryOperator<T> f) {
    if (listHelper == null) {
  ...
  public static <T, U> U reduce(ListHelper<T> listHelper, U unit,
    BiFunction<U, T, U> f) {
    if (listHelper == null) {
      return unit;
    }
