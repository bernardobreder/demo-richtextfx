...
public interface AccumulationFacility<T, A> {
  ...
  interface NoAccumulation<T> extends IllegalAccumulation<T, T>,
  ...
  interface ListChangeAccumulation<E> extends
    ...
    @Override
    default ListChangeAccumulator<E> reduce(ListModificationSequence<E> accum,
      QuasiListChange<? extends E> value) {
