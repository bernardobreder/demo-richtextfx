...
public class Tuple4<A, B, C, D> {
  ...
  public <T> T map(
    TetraFunction<? super A, ? super B, ? super C, ? super D, ? extends T> f) {
    return f.apply(_1, _2, _3, _4);
  }

  public boolean test(
    TetraPredicate<? super A, ? super B, ? super C, ? super D> f) {
    return f.test(_1, _2, _3, _4);
  }

  public void exec(
    TetraConsumer<? super A, ? super B, ? super C, ? super D> f) {
  ...
  public String toString() {
    return "(" + Objects.toString(_1) + ", " + Objects.toString(_2) + ", "
      + Objects.toString(_3) + ", " + Objects.toString(_4) + ")";
  }
}
