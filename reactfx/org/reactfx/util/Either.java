...
public interface Either<L, R> {
  ...
  <L2, R2> Either<L2, R2> map(Function<? super L, ? extends L2> f,
    Function<? super R, ? extends R2> g);

  <L2, R2> Either<L2, R2> flatMap(Function<? super L, Either<L2, R2>> f,
  ...
  <T> T unify(Function<? super L, ? extends T> f,
...
class Left<L, R> implements Either<L, R> {
  ...
  @Override
  public <L2, R2> Either<L2, R2> map(Function<? super L, ? extends L2> f,
    Function<? super R, ? extends R2> g) {
    return new Left<>(f.apply(value));
  }

  @Override
  public <L2, R2> Either<L2, R2> flatMap(Function<? super L, Either<L2, R2>> f,
    Function<? super R, Either<L2, R2>> g) {
    return f.apply(value);
  }
  ...
  @Override
  public <T> T unify(Function<? super L, ? extends T> f,
    Function<? super R, ? extends T> g) {
    return f.apply(value);
  }
