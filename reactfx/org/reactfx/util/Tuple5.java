...
public class Tuple5<A, B, C, D, E> {
  ...
  public <T> T map(
    PentaFunction<? super A, ? super B, ? super C, ? super D, ? super E, ? extends T> f) {
    return f.apply(_1, _2, _3, _4, _5);
  }

  public boolean test(
    PentaPredicate<? super A, ? super B, ? super C, ? super D, ? super E> f) {
    return f.test(_1, _2, _3, _4, _5);
  }

  public void exec(
    PentaConsumer<? super A, ? super B, ? super C, ? super D, ? super E> f) {
    ...
    if (other instanceof Tuple5) {
      ...
      return Objects.equals(this._1, that._1) && Objects.equals(this._2,
        that._2) && Objects.equals(this._3, that._3) && Objects.equals(this._4,
          that._4) && Objects.equals(this._5, that._5);
    }
    else {
      return false;
    }
