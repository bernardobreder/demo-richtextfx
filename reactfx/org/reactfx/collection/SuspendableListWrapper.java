...
final class SuspendableListWrapper<E> extends
  SuspendableBase<LiveList.Observer<? super E, ?>, QuasiListChange<? extends E>, ListModificationSequence<E>>
  ...
  SuspendableListWrapper(ObservableList<E> source) {
    super(LiveList.quasiChangesOf(source), NotificationAccumulator
      .listNotifications());
  ...
  @Override
  protected QuasiListChange<? extends E> headOf(
