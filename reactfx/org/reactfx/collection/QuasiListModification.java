...
public interface QuasiListModification<E> extends ListModificationLike<E> {
  ...
  static <E> ListModification<E> instantiate(
    QuasiListModification<? extends E> template, ObservableList<E> list) {
    return new ListModificationImpl<>(template, list);
  }

  static <E> MaterializedListModification<E> materialize(
    QuasiListModification<? extends E> template, ObservableList<E> list) {
    return new MaterializedListModificationImpl<>(template, list.subList(
      template.getFrom(), template.getTo()));
  }
...
class QuasiListModificationImpl<E> implements QuasiListModification<E> {
  ...
  QuasiListModificationImpl(int position, List<? extends E> removed,
    int addedSize) {
  ...
  public String toString() {
    return "[modification at: " + getFrom() + ", removed: " + getRemoved()
