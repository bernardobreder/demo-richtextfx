...
public interface LiveList<E> extends ObservableList<E>,
  ...
  public interface Observer<E, O> {
    ...
    <F extends E> ListModificationSequence<F> tailOf(
  ...
  @FunctionalInterface
  public interface QuasiChangeObserver<E> extends
    Observer<E, QuasiListChange<? extends E>> {
  ...
  @FunctionalInterface
  public interface QuasiModificationObserver<E> extends
    Observer<E, QuasiListModification<? extends E>> {
  ...
  default void removeQuasiChangeObserver(
    QuasiChangeObserver<? super E> observer) {
    removeObserver(observer);
  }

  default void addQuasiModificationObserver(
    QuasiModificationObserver<? super E> observer) {
    addObserver(observer);
  }

  default void removeQuasiModificationObserver(
    QuasiModificationObserver<? super E> observer) {
    removeObserver(observer);
  }

  default void addChangeObserver(
    Consumer<? super ListChange<? extends E>> observer) {
    addQuasiChangeObserver(new ChangeObserverWrapper<>(this, observer));
  }

  default void removeChangeObserver(
    Consumer<? super ListChange<? extends E>> observer) {
    removeQuasiChangeObserver(new ChangeObserverWrapper<>(this, observer));
  }

  default void addModificationObserver(
    Consumer<? super ListModification<? extends E>> observer) {
    addQuasiModificationObserver(new ModificationObserverWrapper<>(this,
      observer));
  }

  default void removeModificationObserver(
    Consumer<? super ListModification<? extends E>> observer) {
    removeQuasiModificationObserver(new ModificationObserverWrapper<>(this,
      observer));
  }

  default Subscription observeQuasiChanges(
    QuasiChangeObserver<? super E> observer) {
    addQuasiChangeObserver(observer);
    return () -> removeQuasiChangeObserver(observer);
  }

  default Subscription observeQuasiModifications(
    QuasiModificationObserver<? super E> observer) {
    addQuasiModificationObserver(observer);
    return () -> removeQuasiModificationObserver(observer);
  }

  default Subscription observeChanges(
    Consumer<? super ListChange<? extends E>> observer) {
    addChangeObserver(observer);
    return () -> removeChangeObserver(observer);
  }

  default Subscription observeModifications(
    Consumer<? super ListModification<? extends E>> observer) {
  ...
  default void removeListener(InvalidationListener listener) {
    removeQuasiChangeObserver(new InvalidationListenerWrapper<>(this,
      listener));
  }
  ...
  @Experimental
  default Val<E> reduceRange(ObservableValue<IndexRange> range,
  ...
  default EventStream<ListModification<? extends E>> modifications() {
    return quasiModifications().map(qm -> QuasiListModification.instantiate(qm,
      this));
  }
  ...
  static <E> Subscription observeQuasiChanges(ObservableList<? extends E> list,
    QuasiChangeObserver<? super E> observer) {
  ...
  static <E> Subscription observeChanges(ObservableList<E> list,
    Consumer<? super ListChange<? extends E>> observer) {

    return observeQuasiChanges(list, qc -> observer.accept(QuasiListChange
      .instantiate(qc, list)));
  }
  ...
  static <E> EventStream<ListChange<? extends E>> changesOf(
    ObservableList<E> list) {
    return quasiChangesOf(list).map(qc -> QuasiListChange.instantiate(qc,
      list));
  }
  ...
  static <E, F> LiveList<F> map(ObservableList<? extends E> list,
    Function<? super E, ? extends F> f) {
    return new MappedList<>(list, f);
  }

  static <E, F> LiveList<F> mapDynamic(ObservableList<? extends E> list,
    ObservableValue<? extends Function<? super E, ? extends F>> f) {
  ...
  static <E> Val<E> reduce(ObservableList<E> list,
    BinaryOperator<E> reduction) {
    return new ListReduction<>(list, reduction);
  }

  @Experimental
  static <E> Val<E> reduceRange(ObservableList<E> list,
    ObservableValue<IndexRange> range, BinaryOperator<E> reduction) {
    return new ListRangeReduction<>(list, range, reduction);
  }

  @Experimental
  static <E, T> Val<T> collapse(ObservableList<? extends E> list,
    Function<? super List<E>, ? extends T> f) {
    return Val.create(() -> f.apply(Collections.unmodifiableList(list)), list);
  }

  @Experimental
  static <E, T> Val<T> collapseDynamic(ObservableList<? extends E> list,
    ObservableValue<? extends Function<? super List<E>, ? extends T>> f) {
    return Val.create(() -> f.getValue().apply(Collections.unmodifiableList(
      list)), list, f);
  }

  /**
   * Returns a {@linkplain LiveList} view of the given
   * {@linkplain ObservableValue} {@code obs}. The returned list will have size
   * 1 when the given observable value is not {@code null} and size 0 otherwise.
   */
...
class ChangeObserverWrapper<T> extends
  WrapperBase<Consumer<? super ListChange<? extends T>>> implements
  QuasiChangeObserver<T> {
  private final ObservableList<T> list;

  ChangeObserverWrapper(ObservableList<T> list,
...
class ModificationObserverWrapper<T> extends
  WrapperBase<Consumer<? super ListModification<? extends T>>> implements
  QuasiModificationObserver<T> {
  private final ObservableList<T> list;

  ModificationObserverWrapper(ObservableList<T> list,
...
class InvalidationListenerWrapper<T> extends WrapperBase<InvalidationListener>
  ...
  public InvalidationListenerWrapper(ObservableList<T> list,
...
class ChangeListenerWrapper<T> extends
  WrapperBase<ListChangeListener<? super T>> implements QuasiChangeObserver<T> {
  private final ObservableList<T> list;

  public ChangeListenerWrapper(ObservableList<T> list,
  ...
  public void onChange(QuasiListChange<? extends T> change) {
    ...
    List<? extends QuasiListModification<? extends T>> modifications = change
      .getModifications();
