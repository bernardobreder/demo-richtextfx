...
public interface MaterializedListModification<E> extends
...
final class MaterializedListModificationImpl<E> extends ListModificationBase<E>
  implements MaterializedListModification<E> {
  private final List<E> added;

  MaterializedListModificationImpl(QuasiListModification<? extends E> template,
    List<E> addedSublist) {
    super(template);
