...
/**
 * Common supertype for {@link QuasiListChange} and
 * {@link ListChangeAccumulator}.
 *
 * @param <E> type of list elements
 */
public interface ListModificationSequence<E> extends
  AbstractListModificationSequence<E, QuasiListModification<? extends E>> {

  /**
   * May be destructive for this object. Therefore, this object should not be
   * used after the call to this method, unless stated otherwise by the
