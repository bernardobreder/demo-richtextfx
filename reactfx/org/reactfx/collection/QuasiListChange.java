...
public interface QuasiListChange<E> extends ListModificationSequence<E> {
  ...
  static <E> ListChange<E> instantiate(QuasiListChange<? extends E> change,
    ObservableList<E> list) {
    return () -> Lists
      .<QuasiListModification<? extends E>, ListModification<? extends E>> mappedView(
        change.getModifications(), mod -> QuasiListModification.instantiate(mod,
          list));
  }
}

@SuppressWarnings("serial")
final class QuasiListChangeImpl<E> extends
  ArrayList<QuasiListModification<? extends E>> implements QuasiListChange<E> {
