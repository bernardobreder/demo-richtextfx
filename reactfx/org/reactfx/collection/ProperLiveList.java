 ...
 * implementation of some {@link LiveList} methods and get additional helper
 * methods for implementations of <em>proper</em> {@linkplain LiveList}.
 */
public interface ProperLiveList<E> extends LiveList<E>,
  ...
  static <E> QuasiListModification<E> elemReplacement(int index, E replaced) {
    return new QuasiListModificationImpl<E>(index, Collections.singletonList(
      replaced), 1);
  }
  ...
  static <E> QuasiListModification<E> rangeInsertion(int index, int size) {
    return new QuasiListModificationImpl<E>(index, Collections.emptyList(),
      size);
  }
