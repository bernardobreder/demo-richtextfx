...
class ThenAccumulateForStream<T, A> extends EventStreamBase<T> implements
  ...
  public ThenAccumulateForStream(EventStream<T> input,
  ...
  private void handleTimeout() {
    ...
    switch (state) {
      case ACC_HAS_EVENT:
        ...
        acc = null;
        state = State.ACC_NO_EVENT; // so that recursively emitted events start
                                    // accumulating
        break;
      case ACC_NO_EVENT:
