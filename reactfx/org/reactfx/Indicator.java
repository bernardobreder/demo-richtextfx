...
public class Indicator implements ObservableBooleanValue, Guardian {
   ...
   *
   * @return a Guard that, when closed, resets this indicator to the original
   *         state.
   */
  public Guard on() {
    if (++on == 1) {
  ...
  /**
   * Runs the given computation, making sure this indicator is on. When done,
   * this indicator is reset to the previous state.
   *
   * <p>
   * Equivalent to
   *
