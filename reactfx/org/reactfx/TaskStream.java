...
public interface TaskStream<T> extends EventStream<Task<T>> {
   ...
   * than the tasks emitted from this stream, due to asynchrony.
   *
   * <p>
   * If a task emitted by this stream fails with exception {@code e},
   ...
   * emitted from {@code canceller}, if the task most recently emitted from this
   * stream has not yet completed, it is cancelled and its result discarded
