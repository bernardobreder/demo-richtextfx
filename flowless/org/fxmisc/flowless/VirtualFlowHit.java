...
public abstract class VirtualFlowHit<C extends Cell<?, ?>> {
  ...
  static <C extends Cell<?, ?>> VirtualFlowHit<C> cellHit(int cellIndex, C cell,
    double x, double y) {
  ...
  private static class HitBeforeCells<C extends Cell<?, ?>> extends
    VirtualFlowHit<C> {
  ...
  private static class HitAfterCells<C extends Cell<?, ?>> extends
    VirtualFlowHit<C> {
    private final Point2D offset;
