...
final class HorizontalHelper implements OrientationHelper {
  ...
  @Override
  public Var<Double> horizontalPositionProperty(VirtualFlow<?, ?> content) {
    return content.lengthPositionEstimateProperty();
  }

  @Override
  public Var<Double> verticalPositionProperty(VirtualFlow<?, ?> content) {
  ...
  @Override
  public <C extends Cell<?, ?>> VirtualFlowHit<C> cellHit(int itemIndex, C cell,
    double bOff, double lOff) {
