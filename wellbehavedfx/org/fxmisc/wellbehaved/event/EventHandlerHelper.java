...
public final class EventHandlerHelper<T extends Event> {
  ...
  public static abstract class Builder<T extends Event> {
    ...
    private static <T extends Event> Builder<T> empty() {
      return new Builder<T>() {
        @Override
        <U extends T> List<EventHandler<? super U>> getHandlers(
    ...
    public <U extends T> Builder<U> addHandler(
    ...
    abstract <U extends T> List<EventHandler<? super U>> getHandlers(
      int additionalCapacity);
  }
  ...
  private static class CompositeBuilder<T extends Event> extends Builder<T> {
    ...
    private CompositeBuilder(Builder<? super T> previousBuilder,
    ...
    <U extends T> List<EventHandler<? super U>> getHandlers(
      int additionalCapacity) {
      List<EventHandler<? super U>> handlers = previousBuilder.getHandlers(
  ...
  public static class On<T extends Event, U extends T> {
    ...
    private On(Builder<? super T> previous,
      EventPattern<? super T, ? extends U> eventMatcher) {
  ...
  public static <T extends Event> Builder<T> startWith(
    EventHandler<? super T> handler) {
  ...
  @SafeVarargs
  public static <T extends Event> EventHandler<? super T> chain(
    EventHandler<? super T>... handlers) {
    ArrayList<EventHandler<? super T>> nonEmptyHandlers = new ArrayList<>(
      handlers.length);
...
class CompositeEventHandler<T extends Event> implements EventHandler<T> {
  ...
  public EventHandler<? super T> without(EventHandler<?> other) {
    if (this.equals(other)) {
      ...
      List<EventHandler<? super T>> newHandlers = new ArrayList<>(handlers
        .size());
      for (EventHandler<? super T> handler : handlers) {
  ...
  public boolean equals(Object other) {
    return other instanceof CompositeEventHandler && this.handlers.equals(
      ((CompositeEventHandler<?>) other).handlers);
  }
