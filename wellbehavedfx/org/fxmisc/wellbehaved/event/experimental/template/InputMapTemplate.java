...
public abstract class InputMapTemplate<S, E extends Event> {
  ...
  public static interface HandlerTemplateConsumer<S, E extends Event> {
    ...
    <F extends E> void accept(EventType<? extends F> t,
    ...
    static <S, E extends Event> HandlerTemplateConsumer<S, E> from(
      ...
      return new HandlerTemplateConsumer<S, E>() {
        @Override
        public <F extends E> void accept(EventType<? extends F> t,
          InputHandlerTemplate<S, ? super F> h) {
  ...
  public final InputMapTemplate<S, E> orElse(
    InputMapTemplate<S, ? extends E> that) {
  ...
  static <S, E extends Event> InputMapTemplate<S, E> upCast(
    InputMapTemplate<S, ? extends E> imt) {
  ...
  @SafeVarargs
  static <S, E extends Event> InputMapTemplate<S, E> sequence(
    InputMapTemplate<S, ? extends E>... templates) {
  ...
  public static <S, T extends Event> InputMapTemplate<S, T> consume(
    EventType<? extends T> eventType, BiConsumer<? super S, ? super T> action) {
  ...
  public static <S, T extends Event, U extends T> InputMapTemplate<S, U> consumeWhen(
    EventPattern<? super T, ? extends U> eventPattern,
    Predicate<? super S> condition, BiConsumer<? super S, ? super U> action) {
    return process(eventPattern, (s, u) -> {
      if (condition.test(s)) {
        action.accept(s, u);
        return Result.CONSUME;
  ...
  public static <S, T extends Event> InputMapTemplate<S, T> consumeWhen(
    EventType<? extends T> eventType, Predicate<? super S> condition,
  ...
  public static <S, T extends Event, U extends T> InputMapTemplate<S, U> ignore(
    EventPattern<? super T, ? extends U> eventPattern) {
    return new PatternActionTemplate<>(eventPattern,
      PatternActionTemplate.CONST_IGNORE);
  }
  ...
  public static <S, T extends Event> InputMapTemplate<S, T> when(
    ...
    return new InputMapTemplate<S, T>() {
      ...
      protected InputHandlerTemplateMap<S, T> getInputHandlerTemplateMap() {
        return imt.getInputHandlerTemplateMap().map(h -> (s, evt) -> condition
          .test(s) ? h.process(s, evt) : Result.PROCEED);
      }
    };
  }
  ...
  public static <S, T, E extends Event> InputMapTemplate<S, E> lift(
    InputMapTemplate<T, E> imt, Function<? super S, ? extends T> f) {

    return new InputMapTemplate<S, E>() {
      @Override
      protected InputHandlerTemplateMap<S, E> getInputHandlerTemplateMap() {
        return imt.getInputHandlerTemplateMap().map(h -> (s, evt) -> h.process(f
          .apply(s), evt));
      }
    };
  }

  public static <S extends Node, E extends Event> void installOverride(
    InputMapTemplate<S, E> imt, S node) {
    Nodes.addInputMap(node, imt.instantiate(node));
  }

  public static <S, N extends Node, E extends Event> void installOverride(
    InputMapTemplate<S, E> imt, S target,
    Function<? super S, ? extends N> getNode) {
    Nodes.addInputMap(getNode.apply(target), imt.instantiate(target));
  }

  public static <S extends Node, E extends Event> void installFallback(
    InputMapTemplate<S, E> imt, S node) {
    Nodes.addFallbackInputMap(node, imt.instantiate(node));
  }

  public static <S, N extends Node, E extends Event> void installFallback(
    InputMapTemplate<S, E> imt, S target,
    Function<? super S, ? extends N> getNode) {
    Nodes.addFallbackInputMap(getNode.apply(target), imt.instantiate(target));
  }

  public static <S extends Node, E extends Event> void uninstall(
    InputMapTemplate<S, E> imt, S node) {
    Nodes.removeInputMap(node, imt.instantiate(node));
  }

  public static <S, N extends Node, E extends Event> void uninstall(
    InputMapTemplate<S, E> imt, S target,
    Function<? super S, ? extends N> getNode) {
...
class PatternActionTemplate<S, T extends Event, U extends T> extends
  InputMapTemplate<S, U> {
  static final BiFunction<Object, Object, Result> CONST_IGNORE = (x,
    y) -> Result.IGNORE;
  ...
  PatternActionTemplate(EventPattern<T, ? extends U> pattern,
    BiFunction<? super S, ? super U, InputHandler.Result> action) {
  ...
  protected InputHandlerTemplateMap<S, U> getInputHandlerTemplateMap() {
    ...
    InputHandlerTemplate<S, T> iht = (s, t) -> pattern.match(t).map(u -> action
      .apply(s, u)).orElse(Result.PROCEED);
  ...
  public boolean equals(Object other) {
    if (other instanceof PatternActionTemplate) {
      PatternActionTemplate<?, ?, ?> that =
        (PatternActionTemplate<?, ?, ?>) other;
      return Objects.equals(this.pattern, that.pattern) && Objects.equals(
...
class InputMapTemplateInstance<S, E extends Event> implements InputMap<E> {
  ...
  public void forEachEventType(HandlerConsumer<? super E> hc) {
    template.forEachEventType(InputMapTemplate.HandlerTemplateConsumer.from(hc,
      target));
  }
  ...
  public boolean equals(Object other) {
    if (other instanceof InputMapTemplateInstance) {
      InputMapTemplateInstance<?, ?> that =
        (InputMapTemplateInstance<?, ?>) other;
      return Objects.equals(this.template, that.template) && Objects.equals(
