...
public interface EventPattern<T extends Event, U extends T> {
  ...
  default <V extends U> EventPattern<T, V> andThen(
    EventPattern<? super U, V> next) {
  ...
  default EventPattern<T, U> onlyIf(Predicate<? super U> condition) {
    return new EventPattern<T, U>() {
      ...
      public Optional<U> match(T event) {
        return EventPattern.this.match(event).map(u -> condition.test(u) ? u
          : null);
      }
  ...
  static <T extends Event> EventPattern<Event, T> eventType(
  ...
  static EventPattern<Event, KeyEvent> keyPressed(KeyCode code,
    KeyCombination.Modifier... modifiers) {
    return keyPressed(new KeyCodeCombination(code, modifiers));
  }

  static EventPattern<Event, KeyEvent> keyPressed(Predicate<KeyCode> keyTest,
    KeyCombination.Modifier... modifiers) {
    return keyPressed(new KeyCodePatternCombination(keyTest, modifiers));
  }

  static EventPattern<Event, KeyEvent> keyPressed(String character,
    KeyCombination.Modifier... modifiers) {
  ...
  static EventPattern<Event, KeyEvent> keyReleased(KeyCode code,
    KeyCombination.Modifier... modifiers) {
    return keyReleased(new KeyCodeCombination(code, modifiers));
  }

  static EventPattern<Event, KeyEvent> keyReleased(Predicate<KeyCode> keyTest,
    KeyCombination.Modifier... modifiers) {
    return keyReleased(new KeyCodePatternCombination(keyTest, modifiers));
  }

  static EventPattern<Event, KeyEvent> keyReleased(String character,
    KeyCombination.Modifier... modifiers) {
  ...
  static EventPattern<Event, KeyEvent> keyTyped(Predicate<String> charTest,
    KeyCombination.Modifier... modifiers) {
    KeyTypedCombination combination = new KeyTypedCombination(charTest,
      modifiers);
    return keyTyped().onlyIf(combination::match);
  }

  static EventPattern<Event, KeyEvent> keyTyped(String character,
    KeyCombination.Modifier... modifiers) {
