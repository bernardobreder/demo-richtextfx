...
class InputHandlerMap<E extends Event> {
  ...
  private final Ops<EventType<? extends E>, InputHandler<? super E>> OPS =
    new Ops<EventType<? extends E>, InputHandler<? super E>>() {
      ...
      @Override
      public InputHandler<E> squash(InputHandler<? super E> v1,
        InputHandler<? super E> v2) {
