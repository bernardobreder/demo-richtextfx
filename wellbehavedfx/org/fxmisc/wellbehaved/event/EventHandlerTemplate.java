...
public interface EventHandlerTemplate<T, E extends Event> {
  ...
  default <U extends T, F extends E> EventHandlerTemplate<U, F> orElse(
    EventHandlerTemplate<U, F> that) {
    return () -> {
      BiConsumer<? super T, ? super E> thisHandler = EventHandlerTemplate.this
        .getHandler();
  ...
  default <U extends T> EventHandlerTemplate<U, E> onlyWhen(
    Predicate<? super U> condition) {
    return () -> {
      BiConsumer<? super T, ? super E> handler = getHandler();
      return (u, e) -> {
        if (condition.test(u)) {
  ...
  default <U extends T, F extends E> EventHandlerTemplate<U, F> ifConsumed(
    BiConsumer<? super U, ? super F> postConsumption) {
    return () -> {
      BiConsumer<? super T, ? super E> handler = getHandler();
      return (u, f) -> {
        handler.accept(u, f);
  ...
  abstract class Builder<T, E extends Event> {
    ...
    private static class CompositeBuilder<T, E extends Event> extends
      Builder<T, E> {
      private final Builder<? super T, ? super E> previousBuilder;

      private final BiConsumer<? super T, ? super E> handler;

      private CompositeBuilder(Builder<? super T, ? super E> previousBuilder,
      ...
      @Override
      <U extends T, F extends E> List<BiConsumer<? super U, ? super F>> getHandlers(
        int additionalCapacity) {
        List<BiConsumer<? super U, ? super F>> handlers = previousBuilder
          .getHandlers(additionalCapacity + 1);
    ...
    public <F extends E> On<T, E, F> on(
    ...
    public <U extends T, F extends E> Builder<U, F> addHandler(
      BiConsumer<? super U, ? super F> handler) {
    ...
    abstract <U extends T, F extends E> List<BiConsumer<? super U, ? super F>> getHandlers(
      int additionalCapacity);
  }
  ...
  class On<T, E extends Event, F extends E> {
    ...
    private On(Builder<? super T, ? super E> previous,
      EventPattern<? super E, ? extends F> eventMatcher) {
    ...
    public <U extends T> Builder<U, E> act(
  ...
  class When<T, E extends Event, F extends E> {
    ...
    private When(Builder<? super T, ? super E> previousBuilder,
      EventPattern<? super E, ? extends F> eventMatcher,
  ...
  static <T, E extends Event> Builder<T, E> startWith(
    BiConsumer<? super T, ? super E> handler) {
