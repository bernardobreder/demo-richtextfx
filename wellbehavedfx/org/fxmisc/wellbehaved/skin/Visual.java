...
/**
 * Represents the view aspect of a JavaFX control. It defines how the control is
 * rendered visually on the screen. The implementations should either implement
 * {@link SimpleVisualBase}, or extend from {@link ComplexVisualBase}.
 *
...
public interface Visual<C extends Control> {
   ...
   * longer being used, in particular to stop observing the control, i.e. remove
   * any listeners, etc.
   */
  void dispose();
